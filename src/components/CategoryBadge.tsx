  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        {/* Check count */}
        <span className="text-[13px] font-medium text-[#9CA3AF] transition-colors duration-75 group-hover:text-[#6B7280]">
        ...
        {/* Chevron */}
        <svg
          className={`w-4 h-4 text-[#9CA3AF] shrink-0 transition-all duration-75 group-hover:text-[#374151] ${expanded ? "rotate-90" : ""}`}
          fill="none"
          viewBox="0 0 24 24"
          strokeWidth={2}
          stroke="currentColor"
      ...
      <div className="mt-1 ml-[18px]">
        <p className={`text-[13px] font-medium leading-[1.5] transition-colors duration-75 ${summaryStyle.base} ${summaryStyle.hover}`}>
          {summary}
        </p>
      </div>
    </button>
